  ...
  const [flyerTwo, setFlyerTwo] = React.useState(false);
    ...
    return (
      <>
        ...
        <div className="relative bg-white dark:bg-slate-900 transition-all">
            ...
            <div className="flex justify-between items-center transition-all dark:border-slate-700 border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
              ...
              <nav className="hidden md:flex space-x-10">
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="group bg-white dark:bg-slate-900 dark:hover:text-white rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
